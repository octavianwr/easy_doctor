...
<script>document.location.href='index.php';</script>
  <?php }
  else  if($_SESSION['id_patient']=="nouser"){
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Easy</strong>Doctor</h1>
                            <div class="description">
                            	<p>
	                            	Masuk Easy Doctor
									Belum punya akun Easy Doctor? Daftar di <a href="signup/signup.php" class="green underline">sini</a>
                </div>
                            	</p>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="signin_process.php" method="post" class="login-form">
									...
									<li>
										<label class="span6">
											<input class="icheck" name="remember_me" type="checkbox">
			                        ...
			                        <button type="submit" class="btn" onclick="window.location.href='signin_process.php'">Masuk</button>
			                    </form>
		                    </div>
                        </div>
                    </div>
