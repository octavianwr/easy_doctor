...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Mei 2017 pada 16.29
...
(11, 'rsa', 'octavian_wr@yahoo.com', '089901650291', '', '', '', 'xregulus', '442490', 'img/'),
(12, 'Octavian', 'octavian_wr@yahoo.com', '089901650291', '', '', '', 'xregulus', '442490', 'img/'),
(13, 'Jawa yara', 'asd@fsa.cs', '089901650291', 'srikandi', '3201', '32', 'row', '442490', 'img/117681.jpg'),
(14, 'KBP', 'kbp@yahoo.com', '087829885849', 'asd', 'KABUPATEN SIMEULUE', 'ACEH', 'kbpasyik', '123', 'img/'),
(15, 'Medika', 'medika@asd.ds', '08990165029', 'sd', 'KOTA BANDA ACEH', 'ACEH', 'med', '123', 'img/');
...
INSERT INTO `doctor` (`id_doctor`, `name`, `email`, `phone_number_doc`, `photo_doctor`, `id_hospital`, `specialization_id`) VALUES
(10, 'andhi', 'a@a.com', '1', '', 6, 1),
(11, 'Bokep', 'ankarayu@gmail.com', '123', '', 5, 2),
(24, 'andhi', 'ankarayu@gmail.com', '11', '', 2, 1),
(29, 'hiks', 'andhi@gmail.com', '1', 'img/', 2, 3),
(30, 'andhi', 'ankarayu@gmail.com', '123', 'img/', 1, 1),
(31, 'aNN', 'ankarayu@gmail.com', '123', 'img/', 1, 2),
(32, 'a', 'ankarayu@gmail.com', '1', 'img/', 1, 3),
(33, 'a', 'a@a.com', '1', 'img/', 1, 1),
(34, 'a', 'a@a.com', '1', 'img/', 1, 2),
(35, 'a', 'ankarayu@gmail.com', '1', 'img/', 1, 3),
(36, 'a', 'ankarayu@gmail.com', '1', 'img//', 1, 2),
(37, '1', 'q@ed', '2', 'img//', 1, 1),
(38, '1', 'a@we', '11', 'img//', 1, 1);
...
(28, '', '', '', '', '0000-00-00', '', '', '', 'img/'),
(29, '', '', '', '', '0000-00-00', '', '', '', 'img/'),
(30, 'xregulus', 'Octavian', 'octavian_wr@yahoo.com', '08990165029', '1996-10-29', '442490', '', 'ashdk', 'img/'),
(31, 'sad', 'as', 'sad@dsa.g', '089901650291', '1777-10-29', 'asd', '', 'sad', 'img/');
...
--
-- Dumping data untuk tabel `specialization`
--

INSERT INTO `specialization` (`id_specialization`, `specialization_name`) VALUES
(1, 'mata'),
(2, 'telinga'),
(3, 'hati');
...
--
ALTER TABLE `patient`
  MODIFY `id_patient` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT for table `specialization`
--
ALTER TABLE `specialization`
  MODIFY `id_specialization` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `doctor`
  ADD CONSTRAINT `doctor_ibfk_1` FOREIGN KEY (`specialization_id`) REFERENCES `specialization` (`id_specialization`) ON DELETE CASCADE ON UPDATE CASCADE;
