...
Easy Doctor
    ...
    <li>
      ...
      <li style="list-style-type:'\f08b'">
	      <a href = "daftar_pasien.php" class="active">Daftar Pasien</a>
	    </li>
      <li style="list-style-type:'\f08b'">
    ...
    <tbody>
      ...
      while($result_booking = mysqli_fetch_array($query_booking)){
        ...
        '<tr>
          ...
          <td class="text-center"><a class="btn btn-success btn-xs" href="delete_patient.php?id='.$result_booking['id_booking'].'">Selesai</a></td>
